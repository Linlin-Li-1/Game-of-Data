...
if session == 'By Country':
    ...
    st.write("""This is the geographical distribution of COVID-19. The gray part means that the corresponding data is missing.""")
...
if session == "Dietary Perspective":
    ...
    fig2 = px.bar(df_importance.sort_values('Importance', ascending = False), 'Feature', 'Importance')
